...
- Front-door pattern kit under `kit/` (failure story, contract, Node/Express/ASP.NET/FastAPI/Go/webhook/outbox snippets).
...
- Kit index links Go middleware and queue/outbox sketches.
